    ...
    <div class="product_main_infos">
        ...
        <div class="gbtr_poduct_details_left_col">
            ...
            if (isset($theretailer_theme_options['out_of_stock_text'])) {
                $out_of_stock_text = $theretailer_theme_options['out_of_stock_text'];
            } else {
                $out_of_stock_text = __('Out of stock', 'theretailer');
            }
            ?>
        ...
        <div class="recently-viewed"><h3>Recently Viewed</h3><?php echo do_shortcode( '[woocommerce_recently_viewed_products per_page="5"]' ) ?></div>
